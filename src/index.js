    ...
    <div class="col-xl-12 col-md-12">
      <div class="d-sm-flex justify-content-between my-4 pb-4 border-bottom">
        <div class="media d-block d-sm-flex text-center text-sm-left">
          <a class="cart-item-thumb mx-auto mr-sm-4" href="./produit.html?id=${
            _id[i]
          }"><img src="${imageUrl[i]}" alt="Product">
            <button class="btn btn-outline-primary btn-sm btn-block mb-2" type="button">Choisir Une Option
            </button>
          </a>            
            <div class="media-body pt-3">
              <h3 class="product-card-title font-weight-semibold border-0 pb-0">Nom : <span class="text-muted mr-2"><a href="#">${
                name[i]
              }</span></a></h3>
                <div class="font-size-sm font-weight-semibold">id : <span class="text-muted mr-2">${
                  _id[i]
                }</span>
                </div>
                <div class="font-size-sm font-weight-semibold">Description : <span class="text-muted mr-2">${
                  description[i]
                }</span>
                </div>
                <div class="font-size-lg text-primary pt-2">Prix : <span class="text-muted mr-2">${
                  price[i] / 100
                }€</span>
                </div>                                     
            </div>
