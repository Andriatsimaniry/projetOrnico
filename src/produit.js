...
<div class="col-xl-12 col-md-12">
 ...
 `;
    ...
    const positionChoixCouleur = document.querySelector(
...
`;
    ...
    btn_envoyerPanier.addEventListener("click", (event) => {
      ...
      // On définit ici qu'une seule quantité, on va incrémenter plus tard pour ajouter
      // les produit avec la vrais quantité.
      let optionsProduit = {
        produitName: utileId.name,
        description: utileId.description,
        imageUrl: utileId.imageUrl,
        colors: choixForm,
        price: (utileId.price * 1) / 100,
        id: id,
        quantite: 1,
      };
      ...
      const popupConfirmation = () => {
        if (
          window.confirm(`${utileId.name} ,Couleur ${choixForm} a été bien ajouter au panier
      ...
      // s'il n'y a pas de produit de produit enregistré dans le local storage
        ...
        console.log("produit non dans le panier");
